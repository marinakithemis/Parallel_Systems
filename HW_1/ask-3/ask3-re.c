...
// cache line is 64 bytes, add padding accordingly
...
int main(int argc, char* argv[]) {
    ...
    cache_line* shared_arr = calloc(num_of_threads, sizeof(cache_line)); MEMCHECK(shared_arr);
